...
image::apim-terminal-setup.png[width=70%]
...
image::mobile-draft-spec-devspace.png[]
...
+
image::mobile-gateway-product.png[] 
...
image::mobile-activedoc-create-file.png[]
...
image::apim-mobile-back-prod-active-users.png[] 
====
...
image::mobile-clientid-env-patch.png[width=70%]
...
image::mobile-mobgateway-env-patch.png[width=60%]
...
image::mobile-sso-env-patch.png[]
...
image::apim_globex_mobile_deployment.png[]
