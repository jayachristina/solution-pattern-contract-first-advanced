...
// image::https://chart.googleapis.com/chart?chs=300x300&amp;cht=qr&amp;chl={qrurl}[Globex Mobile,200,300]
// Alternatively, 

* Launch https://globex-mobile-globex-apim-{user_name}.{openshift_subdomain}[Globex Mobile^] and login using (asilva/openshift)
